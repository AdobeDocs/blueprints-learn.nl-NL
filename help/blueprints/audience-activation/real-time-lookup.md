...
description: '] toegang van het Profiel van de Klant in real time [!UICONTROL  bij de rand om context voor Web en mobiele verpersoonlijking in real time te verstrekken.'
...
1. In de catalogus van Doelen, opstelling de ](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/custom-personalization) bestemming van de Verbinding van Personalization van 0} Douane:[
