...
description: ' toegang van het Profiel van de Klant in real time  bij de rand om context voor Web en mobiele verpersoonlijking in real time te verstrekken.'
...
De verpersoonlijking van Edge kan worden uitgevoerd gebruikend de [&#128279;](https://experienceleague.adobe.com/nl/docs/experience-platform/destinations/catalog/personalization/custom-personalization) bestemming van de Verbinding van 1&rbrace; Douane van Personalization in het Platform van Gegevens van de Klant in real time. Deze bestemming steunt veelvoudige methodes van de gegevensinzameling afhankelijk van uw gebruiksgeval.
...
1. Voer [&#128279;](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html?lang=nl-NL) of [&#x200B; Mobiele SDK van het Web van Adobe Experience Platform &#x200B;](https://developer.adobe.com/client-sdks/home/) op Web en mobiele eigenschappen voor gegevensinzameling uit.
1. Vorm randsegmentatie voor publiek dat evaluatie in real time vereist. [Edge segmentation documentatie &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/edge-segmentation.html?lang=nl-NL).
1. In de catalogus van Doelen, opstelling de [&#128279;](https://experienceleague.adobe.com/nl/docs/experience-platform/destinations/catalog/personalization/custom-personalization) bestemming van de Verbinding van Personalization van 0&rbrace; Douane:
...
>[!IMPORTANT]
>
>Profielkenmerken kunnen vertrouwelijke gegevens bevatten. Om dit gegeven te beschermen, moet u **gebruiken [&#x200B; de Server API van Edge Network &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html?lang=nl-NL) wanneer het vormen van de bestemming van Personalization van de Douane voor op attribuut-gebaseerde verpersoonlijking.** Alle API-aanroepen van Edge Network Server moeten in een geverifieerde context worden uitgevoerd.
...
* [Overzicht Personalization-bestemmingen](https://experienceleague.adobe.com/nl/docs/experience-platform/destinations/catalog/personalization/overview)
* [Het publiek activeren voor verpersoonlijkingsdoelen van randen](https://experienceleague.adobe.com/nl/docs/experience-platform/destinations/ui/activate/activate-edge-personalization-destinations)
* [Profielkenmerken aan de rand in real-time opzoeken](https://experienceleague.adobe.com/nl/docs/experience-platform/destinations/ui/activate/activate-edge-profile-lookup)

### SDK-documentatie

* [Experience Platform Web SDK-documentatie](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html?lang=nl-NL)
* [Experience Platform Mobile SDK-documentatie](https://developer.adobe.com/client-sdks/home/)
* [Edge Network Server API-documentatie](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html?lang=nl-NL)
* [Experience Platform-tagdocumentatie](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=nl-NL)
* [Opdrachtreacties in Web SDK](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/commands/command-responses.html?lang=nl-NL)

### Documentatie voor profiel en segmentatie

* [] documentatie van het Profiel van de Klant in real time[[!UICONTROL &#x200B;]](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html?lang=nl-NL)
* [Profielhulplijnen](https://experienceleague.adobe.com/docs/experience-platform/profile/guardrails.html?lang=nl-NL)

### Tutorials

* [Volgend-klare personalisatie met Real-Time CDP en Adobe Target](https://experienceleague.adobe.com/docs/platform-learn/tutorials/experience-cloud/next-hit-personalization.html?lang=nl-NL)
