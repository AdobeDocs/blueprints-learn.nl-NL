...
1. Voer [&#128279;](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html) of [&#x200B; Mobiele SDK van het Web van Adobe Experience Platform &#x200B;](https://developer.adobe.com/client-sdks/home/) op Web en mobiele eigenschappen voor gegevensinzameling uit.
1. Vorm randsegmentatie voor publiek dat evaluatie in real time vereist. [Edge segmentation documentatie &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/edge-segmentation.html).
1. In de catalogus van Doelen, opstelling de [&#128279;](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/custom-personalization) bestemming van de Verbinding van Personalization van 0&rbrace; Douane:
...
* [Overzicht Personalization-bestemmingen](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/overview)
* [Het publiek activeren voor verpersoonlijkingsdoelen van randen](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/ui/activate/activate-edge-personalization-destinations)
* [Profielkenmerken aan de rand in real-time opzoeken](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/ui/activate/activate-edge-profile-lookup)

### SDK-documentatie

* [Experience Platform Web SDK-documentatie](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html)
* [Experience Platform Mobile SDK-documentatie](https://developer.adobe.com/client-sdks/home/)
* [Edge Network Server API-documentatie](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html)
* [Experience Platform-tagdocumentatie](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html)
* [Opdrachtreacties in Web SDK](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/commands/command-responses.html)

### Documentatie voor profiel en segmentatie

* [] documentatie van het Profiel van de Klant in real time[[!UICONTROL &#x200B;]](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html)
* [Profielhulplijnen](https://experienceleague.adobe.com/docs/experience-platform/profile/guardrails.html)

### Tutorials

* [Volgend-klare personalisatie met Real-Time CDP en Adobe Target](https://experienceleague.adobe.com/docs/platform-learn/tutorials/experience-cloud/next-hit-personalization.html)
