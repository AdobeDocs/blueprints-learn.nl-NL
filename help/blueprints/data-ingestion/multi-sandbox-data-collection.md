...
1. Auteurs van tags definiëren zowel een eigenschap tag als een eigenschap voor het doorsturen van gebeurtenissen. Hier, zullen de auteurs de gegevenselementen, de regels en de acties bepalen die gegevensinzameling beheren. Houd in mening, loopt de code van het markeringsbezit op de cliënt en door een Gastheer CDN wordt verdeeld. De door:sturen van de Gebeurtenis de code van het Bezit loopt op de Server van Adobe Edge.
...
1. Platform [!DNL Edge Network] Ontvangt gegevens inzamelingspayloads en organiseert de stroom van gegevens aan de vereiste systemen zoals Doel en Analytics.
