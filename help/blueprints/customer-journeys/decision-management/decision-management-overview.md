...
Raadpleeg de volgende documentatie voor handleidingen met betrekking tot Beslissingsbeheer. [Handleidingen voor beslissingsbeheer ](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/guardrails#decision-management.html)
...
<img src="images/offers_overview.png" alt="Beslissingsbeheer" style="width:100%; border:1px solid #4a4a4a" />
