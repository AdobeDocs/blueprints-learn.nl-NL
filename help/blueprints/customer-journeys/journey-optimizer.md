...
Adobe [!DNL Journey Optimizer] is een speciaal gebouwd systeem voor marketingteams om in real-time te reageren op het gedrag van klanten en hen te ontmoeten waar zij zich bevinden. De mogelijkheden voor gegevensbeheer zijn verplaatst naar de Adobe [!DNL Experience Platform] , zodat marketingteams zich kunnen richten op wat ze het beste doen: dit creëert de reis van klanten van wereldklasse en persoonlijke gesprekken.
...
[[!DNL Journey Optimizer]  Guardrails Product Link ](https://experienceleague.adobe.com/nl/docs/journey-optimizer/using/get-started/guardrails)
...
* [[!DNL Experience Platform]  documentatie van Markeringen ](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=nl-NL)
