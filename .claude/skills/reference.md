...
|------|---------|--------------------|
| **Overzicht / hub** | Introduceert een product of een gebied; verbindingen aan scenario blauwdrukken | e.g. `overview.md`, `journey-optimizer-overview.md` |
| **blauwdruk van het Scenario** | Hoofdlettergebruik voor eenmalig gebruik: architectuur, stappen, instructies | e.g. `real-time-lookup.md`, `journey-optimizer-journeys.md` |
...
| Experience League (en) | `https://experienceleague.adobe.com/en/docs/` | Dezelfde structuur als hierboven met `/en/` . |
...
- **Beschrijvende verbindingstekst**: `[Create schemas](https://experienceleague.adobe.com/...)` &quot;klik hier niet&quot;.
